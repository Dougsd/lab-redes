...
Menu(){
	...
	echo -e 'DHCP##########' 
	echo "[ 4 ] CRIA NOVO SCOPO E RESERVA (APAGA O SCOPO EXISTENTE CASO HAJA)"
	echo "[ 5 ] ADICIONAR RESERVA A SCOPO JA EXISTENTE"
	echo -e 'DNS##########' 
	echo "[ 6 ] CRIA NOVA ZONA(APAGA AS ZONAS EXISTENTES CASO HAJA)"
	echo "[ 7 ] ADICIONAR HOST A UM ZONA JA EXISTENTE"
	echo "[ 0 ] SAIR"
